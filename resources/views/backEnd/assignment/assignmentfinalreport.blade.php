        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <small>Assignment P & L Report Listtata</small>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table id="examplee" class="display nowrap">
                            ...
                            <tbody>
                                ...
                                @foreach ($invoiceData as $invoiceDatas)
                                    @php
                                        $invoiceDatastotal = DB::table('invoices')
                                            ->where('assignmentgenerate_id', $invoiceDatas->assignmentgenerate_id)
                                            ->sum('total');
                                        ...
                                        foreach ($costing as $costingData) {
                                            $avgcost = DB::table('teammembers')
                                                ->where('id', $costingData->createdby)
                                                ->pluck('cost_hour')
                                                ->first();
                                            if ($avgcost == null) {
                                                $avgcost = '0';
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($invoiceDatas->assignment_name != null)
                                                <a target="blank"
                                                    href="{{ url('assignmentcosting/' . $invoiceDatas->assignmentgenerate_id) }}">
                                                    <span>{{ $invoiceDatas->assignment_name ?? '' }} (
                                                        {{ $invoiceDatas->assignmentgenerate_id }} )</span></a>
                                            @endif
                                        </td>
