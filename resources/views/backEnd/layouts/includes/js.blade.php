         ...
         $(document).ready(function() {
             var dataTable = $('#tableData').DataTable({
                 ...
                 "initComplete": function(settings, json) {
                     $('#tableData thead tr').clone(true).addClass('filters').appendTo(
                         '#DataTable thead');
         ...
         $(document).ready(function() {
             ...
             $('#formevv').bind("change keyup", function() {
                 ...
                 $.ajax({
                     ...
                     data: 'clientid=' + clientid + '&assignmentid=' + assignmentid + '&partnerid=' +
                         partnerid + '&employeeid=' + employeeid + '&status=' + status,
                     success: function(data) {
                         ...
                         $.each(data, function(index, value) {
                             ...
                             row.append($('<td>').html(
                                 $('<a>').attr('href',
                                     '/view/assignmentevaluation/' + value.id)
                                 .text(value.creator_team_member)
                             ));
