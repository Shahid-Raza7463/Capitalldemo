@extends('backEnd.layouts.layout') @section('backEnd_content')
    ...
    <div class="content-header row align-items-center m-0">
        ...
        <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
            <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
                ...
                <li style="margin-left: 13px;"> <a class="btn btn-primary"
    ...
    @endif
                ...
                <br>
                <br>
                {{-- @if (Auth::user()->role_id == 13 || Auth::user()->role_id == 11 || Auth::user()->role_id == 14 || $assignmentbudgetingDatas->type == 0) --}}
                {{-- @if (Auth::user()->role_id == 13 || $assignmentbudgetingDatas->type == 0 || $assignmentbudgetingDatas->status == 1 || ($assignmentbudgetingDatas->type != 0 && $assignmentbudgetingDatas->status == 0))
                    <div class="row">
                        <div class="col-md-7">
                            <div class="card" style="box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2);height:250px;">
                                <div class="card-body">
                                    ...
                                    <div class="card-head">
                                        <b>UDIN List</b>
                                        @if (Auth::user()->role_id != 11 && $assignmentbudgetingDatas->type == 0 && $assignmentbudgetingDatas->status == 1)
                    ...
                    <div class="row">
                        @php
                            ...
                            if ($assignmentcheckk == null) {
                                ...
                                $ssub = App\Models\Subfinancialclassfication::where('financialstatemantclassfication_id', $assignmentcheckData->id)->get();
                            }
                                            ...
                                            <ul class="todo-list examplee">
                                                @php
                                                    ...
                                                    if ($auditquestionscheck == null) {
                                                        $subb = App\Models\Auditquestion::leftJoin('subfinancialclassfications', function ($join) {
                                                        ...
                                                        <label for="todo1"> <a
                                                            ...
                                                            @php
                                                                $status = App\Models\Checklistanswer::leftJoin('statuses', function ($join) {
                                                                    ...
                                                                    ->where('assignment_id', $assignmentbudgetingDatas->assignmentgenerate_id)
                                                                    ->select('statuses.*')
                                                                    ->orderBy('id', 'asc')
                                                                    ->first();
                                                                ...
                                                                $countan = App\Models\Checklistanswer::leftJoin('statuses', function ($join) {
                                                                    $join->on('checklistanswers.status', 'statuses.id');
                                                                })
                                                                    ->where('steplist_id', $sub->id)
                                                                    ->where('financialstatemantclassfication_id', $ssub->financialstatemantclassfication_id)
