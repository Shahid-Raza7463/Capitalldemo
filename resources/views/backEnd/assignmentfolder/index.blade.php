    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="detailsForm" method="post" action="{{ route('assignmentfolder.store') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="details-form-field form-group row">
                            ...
                            <input hidden class="form-control" name="assignmentgenerateid" value="{{ $id ?? '' }}"
                                type="text">
                        </div>
...
<div class="modal fade bd-example-modal-sm" id="modaldemo1" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header" style="background: #37A000">
                <h5 style="color: white" class="modal-title font-weight-600" id="exampleModalLabel1">Update Folder Name
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <form method="post" action="{{ url('assignmentfolder_nameupdate') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <input class="form-control" required placeholder="Update Folder Name" name="name"
                        id="names" type="text">
