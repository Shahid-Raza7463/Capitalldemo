...
<div class="row row-sm">
    <div class="col-12">
        <div class="form-group">
            ...
            <textarea type="text" name="description" class="form-control" placeholder="">{{ $holiday->description ?? '' }}</textarea>
...
<br>
<p style="text-align:center; background-color:Gray; color:white;"><b>Note</b> : Shift based Holidays will override the
    location based Holidays.</p>
<br>
