            ...
            <div class="table-responsive">
                <table class="table display table-bordered table-striped table-hover basic">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td> <a href="{{route('assignmentbudgeting.edit', $assignmentbudgetingData->id)}}"> {{$assignmentbudgetingData->client_name}}</a></td>
                            <td>{{$assignmentbudgetingData->assignment_name}} @if($assignmentbudgetingData->assignmentname !=  null)( {{ $assignmentbudgetingData->assignmentname }} ) ( {{$assignmentbudgetingData->assignmentgenerate_id}}  )@endif</td>
