option<!-- <link href="https://cdn.datatables.net/1.10.25/css/jquery.dataTables.min.css" rel="stylesheet">
    ...
    <div class="content-header row align-items-center m-0">
        <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
            <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-green mb-0 float-sm-right">
                <li class="breadcrumb-item"><a href="" style="color:white;" onClick="window.location.reload();">Reset
                        Filters</a>
                </li>
                    ...
                    <div class="row row-sm">
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <select required class="language form-control" multiple="" name="client[]"
                                    id="client">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <select required class="language form-control" multiple="" name="assignment[]"
                                    id="assignment">
                                    <option value="">Please Select One</option>
                        ...
                        <div class="col-3" id="cust_date" style="display:none;">
                            <div class="form-group">
                                ...
                                <input class="form-control key dateFilter" type="text" name="daterange"
                                    id="daterange" value=" ">
                            </div>
                        </div>
